...
<head>
    ...
    <title>Product Verification | {{ $company['name'] ?? 'Punit ERP' }}</title>
    <style>
...
<main class="verify-shell">
    <header class="verify-hero">
        ...
        <h1>{{ $company['name'] ?? 'Verified Manufacturer' }}</h1>
    ...
    <footer class="verify-footer">Verification record <span class="verify-id">{{ substr($verification->id, 0, 8) }}</span> · Scanned securely via Punit ERP</footer>
</main>
</body>
</html>
