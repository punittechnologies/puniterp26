...
#[Fillable(['tenant_id', 'field_label', 'internal_key', 'description', 'entity_type', 'data_type', 'is_required', 'default_value', 'placeholder', 'help_text', 'validation_rules', 'dropdown_options', 'visible_in_web', 'visible_in_flutter', 'editable_in_flutter', 'printable_on_label', 'use_as_weight_divisor', 'visible_in_reports', 'searchable', 'filterable', 'sort_order', 'conditional_visibility', 'formula_definition', 'is_active', 'configuration_version', 'created_by', 'updated_by'])]
